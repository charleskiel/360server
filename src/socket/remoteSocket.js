...
var credentials = {
	key: fs.readFileSync('f:/Projects/letsencrypt/live/360tv.net/privkey.pem', 'utf8'),
	cert: fs.readFileSync('f:/Projects/letsencrypt/live/360tv.net/fullchain.pem', 'utf8')
};

var httpsServer = https.createServer(credentials).listen(5002, function() {
